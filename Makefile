...
$(build_dir)/APPLICATION_DONE: $(proton_train) $(gamma_train) $(model_separator) $(config_separator) $(gamma_test) $(proton_test) $(model_regressor)
	klaas_apply_separation_model $(config_separator) $(gamma_test) $(model_separator) --yes --chunksize 10000
	klaas_apply_separation_model $(config_separator) $(proton_test) $(model_separator) --yes --chunksize 10000
	klaas_apply_energy_regressor $(config_regressor) $(gamma_test) $(model_regressor) --yes --chunksize 10000
...
# $(gamma_dl3) : matplotlibrc processing/reconstruct_direction.py $(gamma_test) $(build_dir)/APPLICATION_DONE
# 	python processing/reconstruct_direction.py $(gamma_test) $(gamma_dl3) ./processing/instrument_description.pkl
# $(proton_dl3) : matplotlibrc processing/reconstruct_direction.py $(proton_test) $(build_dir)/APPLICATION_DONE
# 	python processing/reconstruct_direction.py $(proton_test) $(proton_dl3) ./processing/instrument_description.pkl
#
# $(gamma_dl3_sst) : matplotlibrc processing/reconstruct_direction.py $(gamma_test) $(build_dir)/APPLICATION_DONE
# 	python processing/reconstruct_direction.py $(gamma_test) $(gamma_dl3_sst) ./processing/instrument_description.pkl -t SST
# $(proton_dl3_sst) : matplotlibrc processing/reconstruct_direction.py $(proton_test) $(build_dir)/APPLICATION_DONE
# 	python processing/reconstruct_direction.py $(proton_test) $(proton_dl3_sst) ./processing/instrument_description.pkl -t SST
#
# $(gamma_dl3_mst) : matplotlibrc processing/reconstruct_direction.py $(gamma_test) $(build_dir)/APPLICATION_DONE
# 	python processing/reconstruct_direction.py $(gamma_test) $(gamma_dl3_mst) ./processing/instrument_description.pkl -t MST
# $(proton_dl3_mst) : matplotlibrc processing/reconstruct_direction.py $(proton_test) $(build_dir)/APPLICATION_DONE
# 	python processing/reconstruct_direction.py $(proton_test) $(proton_dl3_mst) ./processing/instrument_description.pkl -t MST
#
# $(gamma_dl3_lst) : matplotlibrc processing/reconstruct_direction.py $(gamma_test) $(build_dir)/APPLICATION_DONE
# 	python processing/reconstruct_direction.py $(gamma_test) $(gamma_dl3_lst) ./processing/instrument_description.pkl -t LST
# $(proton_dl3_lst) : matplotlibrc processing/reconstruct_direction.py $(proton_test) $(build_dir)/APPLICATION_DONE
...
$(sensitivity_all_fits): $(gamma_test) $(proton_test)
	python effective_area/calculate_sensitivity.py $(gamma_test) $(proton_test) $(sensitivity_all_fits) -n 20 -j 4 -i 5
